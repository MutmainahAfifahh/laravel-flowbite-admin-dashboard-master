        ...
        <section>
            ...
            <x-table.table-layout :title="'List Action Stock Transaction'" :description="'History Transaction In/Out Item Products'">
                ...
                @slot('header')
                    ...
                    <th class="p-4 text-xs font-medium tracking-wider text-center text-gray-500 uppercase dark:text-white">Supplier</th>
                ...
                @forelse ($stockByType as $transaction)
                    ...
                    <tr>
                        ...
                        <td class="p-4 text-sm font-normal text-gray-900 text-center whitespace-nowrap border-b dark:border-gray-500 dark:text-white">
                            {{ $transaction->supplier->name ?? $transaction->products->supplier->name ?? '-' }}
                        </td>
                        <td class="p-4 text-sm font-normal text-gray-900 text-center whitespace-nowrap border-b dark:border-gray-500 dark:text-white">
            ...
            <x-table.table-layout :title="'Stock Transaction by Filter'" :description="'Filter Stock Transaction Item Products'">
                ...
                @forelse ($stockByCriteria as $transaction)
                    ...
                    <tr>
                        ...
                        <td class="p-4 text-sm font-normal text-gray-900 text-center whitespace-nowrap border-b dark:border-gray-500 dark:text-white">{{ $transaction->supplier->name ?? $transaction->products->supplier->name ?? '-' }}</td>
                        <td class="p-4 text-sm font-normal text-gray-900 text-center whitespace-nowrap border-b dark:border-gray-500 dark:text-white">
                ...
                @empty
                    <tr>
                        <td colspan="8" class="p-4 text-sm text-center font-semibold italic text-gray-900 border-b whitespace-nowrap dark:border-gray-500 dark:text-white">
                            Data Not Found
                        </td>
                    </tr>
                @endforelse
